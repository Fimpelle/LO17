...
public class Normalisator {
	...
	private final String lemmesFilePath;

	public Normalisator(String lemmesFilePath) {
		this.lemmesFilePath = lemmesFilePath;
	}

	public String normalize(String request) {
		Lexique lexique = new Lexique(lemmesFilePath);
